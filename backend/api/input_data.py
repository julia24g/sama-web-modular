...
class InputData:
    ...
    def other_parameters(self):
        ...
        self.ir = (n_ir - e_ir) / (1 + e_ir);  # real discount rate
        ...
        self.D_WT = 0.05;  # WT yearly degradation
        ...
        if self.Bat == 1:
            ...
            self.RT_CH = np.ceil(self.n / self.L_CH) - 1;  # Replecement time
        else:
        ...
        self.Cbuy = calcTouCbuy(daysInMonth, months, holidays)
        self.Csell = 0.1

        self.Pbuy_max = np.ceil(1.2 * max(self.Eload))  # kWh
